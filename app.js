...
function infoIcon() {
  return `<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>`;
}
...
function detailSections(r) {
  ...
  return {
    ...
    <div class="sec grow">
      ...
      <textarea id="m-body" class="box orig edit grow-fill" style="min-height:300px">${esc(r.body)}</textarea>
    </div>`,
    classify: `
    <div class="sec">
...
function statusBar(r) {
  ...
  <div class="status-bar">
    <div class="status-change">
      <div class="sc-control"><span class="lab">상태 변경</span><select id="m-status">${opts}</select></div>
